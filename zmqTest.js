// Replicate the testZmqInHost command logic
const vscode = {
  Uri: {
    parse: function(str) {
      return { toString: () => str };
...
const fs = require('fs');
const os = require('os');
// We need to load the KernelManager from the compiled output
const KernelManager = require('./dist/kernel/kernelManager.js').KernelManager;
